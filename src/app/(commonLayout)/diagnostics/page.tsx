...
const DiagnosticsPage = () => {
  ...
  return (
    <div className="container mx-auto px-4 py-12 text-muted">
      ...
      <Card className="bg-background mb-12 border-none">
          ...
          <div className="max-w-3xl mx-auto">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              <div className="flex gap-3">
                <div className="shrink-0 w-10 h-10 bg-foreground rounded-full flex items-center justify-center text-muted">
                  ✓
                </div>
      ...
      <div className="text-center ">
        <Card className="inline-block bg-green-100">
          <CardContent className="p-8 ">
            ...
            <Link href="/">
              <Button size="lg" className="bg-chart-1 hover:bg-chart-1/70">
                Back to Home
              </Button>
            </Link>
          </CardContent>

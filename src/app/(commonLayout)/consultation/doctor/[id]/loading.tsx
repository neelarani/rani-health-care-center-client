            ...
            <div className="flex-1 space-y-4">
              ...
              <div className="space-y-2">
                ...
                <div className="flex flex-wrap gap-2">
                  <Skeleton className="h-6 w-28 rounded-full bg-foreground" />
                  <Skeleton className="h-6 w-24 rounded-full bg-foreground" />
                  <Skeleton className="h-6 w-32 rounded-full bg-foreground" />
                </div>
              </div>
            </div>

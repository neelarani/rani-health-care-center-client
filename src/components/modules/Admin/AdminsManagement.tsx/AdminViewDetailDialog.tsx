    ...
    <Dialog open={open} onOpenChange={onClose}>
      <DialogContent className="min-w-5xl max-h-[90vh] flex flex-col p-0 bg-foreground text-muted">
        ...
        <div className="flex-1 overflow-y-auto px-6 pb-6">
          ...
          <div className="flex flex-col sm:flex-row items-center sm:items-start gap-6 p-6  dark:from-blue-950 dark:to-indigo-950 rounded-lg mb-6">
          ...
          <div className="space-y-6">
            ...
            <div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4 bg-background p-4 rounded-lg">
                ...
                <div className="flex items-start gap-3">
                  <Shield className="h-4 w-4 mt-1 text-muted" />

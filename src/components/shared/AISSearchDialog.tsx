    ...
    <Dialog open={open} onOpenChange={handleDialogOpenChange}>
      <DialogTrigger asChild>
        <Button variant="outline" size="sm" className="gap-2 text-muted ">
          ...
          <span className="hidden sm:inline hover:text-background">
            AI Search
          </span>
        </Button>
      </DialogTrigger>
      <DialogContent className="max-w-3xl max-h-[90vh] overflow-y-auto bg-foreground border-muted-foreground/40">
        <DialogHeader>
          <div className="flex items-center gap-2">
            ...
            <div>
              <DialogTitle className="text-muted">AI Doctor Search</DialogTitle>
